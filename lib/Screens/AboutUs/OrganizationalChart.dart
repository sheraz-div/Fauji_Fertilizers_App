...
class OrganizationalChartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Organizational Chart - PARC"),
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                "Organizational Chart - PARC (Download for good quality)",
              ...
              Center(
                child: GestureDetector(
                  ...
                  child: Image.asset(
                    'assets/images/Organo_Chart .png',  // Replace with your actual image path
                    height: 300,
                    width: 300,
                    fit: BoxFit.contain,
                  ),
              ...
              ElevatedButton.icon(
                onPressed: () async {
                  await _downloadFile(context, 'assets/images/Organo_Chart .png');
                },
  ...
  Future<void> _downloadFile(BuildContext context, String filePath) async {
    ...
    if (path != null) {
      final file = File('$path/Organo_Chart .png');
      ...
      body: PhotoViewGallery.builder(
        ...
        builder: (context, index) {
          return PhotoViewGalleryPageOptions(
            imageProvider: AssetImage('assets/images/Organo_Chart .png'),  // Path to your image
